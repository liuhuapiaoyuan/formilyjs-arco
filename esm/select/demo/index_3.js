...
var useAsyncDataSource = function (service) { return function (field) {
    var _a;
    field.loading = true;
    service(field).then((_a = action === null || action === void 0 ? void 0 : action.bound) === null || _a === void 0 ? void 0 : _a.call(action, function (data) {
...
export default (function () { return (React.createElement(FormProvider, { form: form },
    React.createElement(SchemaField, { schema: schema, scope: { useAsyncDataSource: useAsyncDataSource, loadData: loadData } }),
