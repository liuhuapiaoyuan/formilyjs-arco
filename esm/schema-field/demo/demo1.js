...
var FormEg = function (props) {
    ...
    return (React.createElement(Form, __assign({ form: form }, rest),
        React.createElement(SchemaRender, { schema: schema, scope: { test: test, useAsyncDataSource: useAsyncDataSource, loadData: loadData } }),
        React.createElement(FormConsumer, null, function () { return React.createElement("div", null, JSON.stringify(form.values)); })));
};
export default (function () { return React.createElement(FormEg, { schema: SchemaInput }); });
