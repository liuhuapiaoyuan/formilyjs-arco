...
import { TreeSelect, Select, FormItem, FormButtonGroup, Submit, } from '@formily/arco';
...
export default (function () { return (React.createElement(FormProvider, { form: form },
    React.createElement(Field, { name: "linkage", title: "\u8054\u52A8\u9009\u62E9\u6846", dataSource: [
    ...
    React.createElement(Field, { name: "select", title: "\u5F02\u6B65\u9009\u62E9\u6846", decorator: [FormItem], component: [
            TreeSelect,
            {
                style: {
                    width: 200,
