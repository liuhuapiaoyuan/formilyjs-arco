...
var useAsyncDataSource = function (service) { return function (field) {
    var _a;
    field.loading = true;
    service(field).then((_a = reactive_1.action === null || reactive_1.action === void 0 ? void 0 : reactive_1.action.bound) === null || _a === void 0 ? void 0 : _a.call(reactive_1.action, function (data) {
        if (data.findIndex(function (_a) {
            var value = _a.value;
...
exports.default = (function () { return (react_1.default.createElement(react_2.FormProvider, { form: form },
    react_1.default.createElement(SchemaField, { schema: schema, scope: { useAsyncDataSource: useAsyncDataSource, loadData: loadData } }),
