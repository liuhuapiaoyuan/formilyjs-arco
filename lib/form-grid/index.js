...
exports.GridColumn = exports.FormGrid = exports.useGridSpan = void 0;
...
var useLayout = function (props) {
    ...
    var formGridPrefixCls = (0, __builtins__1.usePrefixCls)('grid');
    var _a = __read((0, react_1.useState)({}), 2), layoutParams = _a[0], setLayout = _a[1];
    var _b = __read((0, react_1.useState)({}), 2), styles = _b[0], setStyles = _b[1];
    var calculateSmartColumns = function (target) {
        ...
        var takeMinWidth = function () {
            ...
            if ((0, shared_1.isValid)(minWidth)) {
                return minWidth[index] || 0;
            }
            else {
                if ((0, shared_1.isValid)(rMaxColumns)) {
        ...
        var takeMaxWidth = function () {
            ...
            if ((0, shared_1.isValid)(maxWidth)) {
                return maxWidth[index] || 0;
            }
            else {
                if ((0, shared_1.isValid)(rMinColumns)) {
    ...
    (0, react_1.useLayoutEffect)(function () {
        var observer = function () {
            ...
            if (!(0, shared_1.isEqual)(style, styles)) {
                setStyles(style);
            }
        };
        var resizeObserver = new resize_observer_polyfill_1.default(observer);
...
var getStyle = function (props) {
    ...
    var getMinMax = function (minWidth, maxWidth) {
        ...
        if (minWidth === Infinity) {
            ...
            minmax = "minmax(".concat(minWidth, "px,").concat((0, shared_1.isValid)(maxWidth) ? "".concat(maxWidth, "px") : '1fr', ")");
        }
        return minmax;
    };
    var spans = Array.from(((_a = ref.current) === null || _a === void 0 ? void 0 : _a.childNodes) || []).reduce(function (buf, cur) {
        var span = (0, shared_1.isValid)(maxColumns)
    ...
    if ((0, shared_1.isValid)(maxColumns)) {
        finalColumns = Math.min(spans, calc, maxColumns);
    }
    else {
        finalColumns = Math.min(spans, calc);
    }
    if ((0, shared_1.isValid)(minColumns)) {
...
var useGridSpan = function (gridSpan) {
    ...
    var params = (0, react_1.useContext)(context_1.FormGridContext);
    if (!(0, shared_1.isValid)(params)) {
        return gridSpan;
    }
...
var FormGrid = function (props) {
    var normalizeProps = function (props) {
        ...
        var normalize = function (prop) {
            if ((0, shared_1.isNum)(prop) || (0, shared_1.isBool)(prop)) {
                return intervals.map(function () { return prop; });
            }
            else if (Array.isArray(prop)) {
                var lastVal_1;
                return intervals.map(function (it, idx) {
                    var res = (0, shared_1.isValid)(prop[idx]) ? prop[idx] : lastVal_1;
                    lastVal_1 = (0, shared_1.isValid)(prop[idx]) ? prop[idx] : lastVal_1;
                    return res;
                });
            }
            else {
    ...
    return (react_1.default.createElement(context_1.FormGridContext.Provider, { value: __assign({ columnGap: props.columnGap }, layoutParams) },
        react_1.default.createElement("div", __assign({}, (0, __builtins__1.pickDataProps)(props), { className: (0, classnames_1.default)("".concat(formGridPrefixCls, "-layout")), style: styles, ref: ref }), children)));
};
exports.FormGrid = FormGrid;
var GridColumn = function (_a) {
    var gridSpan = _a.gridSpan, children = _a.children;
    var span = exports.FormGrid.useGridSpan(gridSpan);
    return (react_1.default.createElement("div", { style: { gridColumnStart: "span ".concat(span) }, "data-span": span || 1 }, children));
};
