...
exports.SchemaInput = {
    ...
    properties: {
        ...
        submit: {
            ...
            'x-content': '哈哈哈',
            'x-component-props': {
                onSubmit: function (e) { return console.log('====', e); },
            },
        },
    },
};
var loadData = function (field) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        input = field.query('input').get('value');
        if (!input) {
            return [2 /*return*/, []];
        }
...
var FormEg = function (props) {
    var schema = props.schema, rest = __rest(props, ["schema"]);
    return (react_1.default.createElement(arco_1.Form, __assign({ form: form }, rest),
        react_1.default.createElement(arco_1.SchemaRender, { schema: schema, scope: { test: test, useAsyncDataSource: useAsyncDataSource, loadData: loadData } }),
...
exports.default = (function () { return react_1.default.createElement(FormEg, { schema: exports.SchemaInput }); });
