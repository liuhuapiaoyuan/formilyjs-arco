...
exports.default = (function () { return (react_1.default.createElement(react_2.FormProvider, { form: form },
    react_1.default.createElement(react_2.Field, { name: "input", title: "\u8F93\u5165\u6846", required: true, decorator: [arco_1.FormItem], component: [
            arco_1.Input,
            {
                style: {
                    width: 240,
    ...
    react_1.default.createElement(react_2.Field, { name: "textarea", title: "\u6587\u672C\u6846", required: true, decorator: [arco_1.FormItem], component: [
